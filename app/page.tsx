    ...
    <main className="mx-auto w-full max-w-5xl flex-1 px-6 py-16 sm:py-24">
      ...
      <footer className="mt-20 border-t border-[var(--border-solid)] pt-6 text-xs text-muted">
        <div className="flex flex-wrap items-center justify-between gap-3">
          ...
          <span>built in public · always experimenting | <a href="https://roxycreates.com" target="_blank" style={{ color: '#ebebeb', textDecoration: 'underline' }} rel="noopener noreferrer" className="text-primary hover:underline">
